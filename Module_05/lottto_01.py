...
def insert():
    ...
    for dic in lotto_list:
        ...
        print(numberlist)
        dataCount = str(count)
        dataNum1 = str(numberlist[0])
        dataNum2 = str(numberlist[1])
        dataNum3 = str(numberlist[2])
        dataNum4 = str(numberlist[3])
        dataNum5 = str(numberlist[4])
        dataNum6 = str(numberlist[5].split('+')[0])
        dataNum7 = str(numberlist[5].split('+')[1])

        dataPerson = str(persons)
        ...
        sql = """INSERT INTO data(`count`, `1`, `2`, `3`, `4`, `5`, `6`, `7`, `person`, `amount`) VALUES("%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s")""" %insertData
