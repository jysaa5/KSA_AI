...
hidden_7 = Dense(units=256, activation='relu', name='hidden_7')(hidden_6)
hidden_8 = Dense(units=256, activation='relu', name='hidden_8')(hidden_7)
hidden_9 = Dense(units=256, activation='relu', name='hidden_9')(hidden_8)
hidden_10 = Dense(units=256, activation='relu', name='hidden_10')(hidden_9)

output_tensor = Dense(num_classes, activation='softmax', name='output_tensor')(hidden_10)
